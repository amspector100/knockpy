...
Knockoffs are a powerful tool which can be used in combination with nearly any machine learning algorithm to control the false discovery rate (FDR) in feature selection. Knockoffs were initially developed in `Barber and Candes 2015`_ and `Candes et al 2018`_.
